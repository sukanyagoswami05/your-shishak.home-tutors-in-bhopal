      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-white text-lg mb-8 animated-element" data-delay="400">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animated-element" data-delay="800">
              <Button 
                ...
                size="lg"
                onClick={() => {
                  window.open("https://wa.me/9244947668?text=Hi%20Your%20Shikshak%20Team%20%F0%9F%91%8B%2C%20I%27m%20looking%20for%20a%20tutor.%20Details%3A%0AStudent%20Name%3A%20%0AClass%3A%20%0ASubjects%3A%20%0AMale%2FFemale%20Preference%3A%20%0ALocation%3A%20%0AGoogle%20Maps%20Link%3A%20%0AContact%20Number%3A%20", "_blank");
                }}
              >
          ...
          <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/20 animated-element shadow-lg" data-delay="1000">
            <h3 className="text-2xl font-semibold mb-6 text-white text-center">Why Parents Trust Us</h3>
            
            <div className="space-y-4">
              <div className="flex items-start gap-4 text-white group hover:bg-white/10 p-4 rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">Our tutors adapt to each student's learning style and pace.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 text-white group hover:bg-white/10 p-4 rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">Simple pricing with no hidden fees or long-term commitments.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 text-white group hover:bg-white/10 p-4 rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">Stay informed with detailed monthly reports on your child's progress.</p>
                </div>
              </div>
            </div>
            
            <div className="mt-6 bg-white/10 p-4 rounded-lg border border-white/10 hover:bg-white/20 transition-colors">
